...
```
      ...
      --cni-bin-path strings                     search path for CNI binaries (default [/home/iberu/.talos/cni/bin])
      ...
      --cni-cache-dir string                     CNI cache directory path (default "/home/iberu/.talos/cni/cache")
      --cni-conf-dir string                      CNI config directory path (default "/home/iberu/.talos/cni/conf.d")
  ...
  -h, --help                                     help for dev
      ...
      --install-image string                     the installer image to use (default "ghcr.io/siderolabs/installer:v1.13.8")
      ...
      --talos-version string                     the desired Talos version to generate config for (default "v1.13.8")
...
```
      ...
      --state string   directory path to store cluster state (default "/home/iberu/.talos/clusters")
```
...
```
  ...
  -h, --help                                     help for docker
      ...
      --image string                             the talos image to run (default "ghcr.io/siderolabs/talos:v1.13.8")
      --kubernetes-version string                desired kubernetes version to run (default "1.36.2")
...
```
  ...
  -h, --help                                     help for qemu
      ...
      --talos-version string                     the desired talos version (default "v1.13.8")
      --talosconfig-destination string           The location to save the generated Talos configuration file to. Defaults to 'TALOSCONFIG' env variable if set, otherwise '$HOME/.talos/config' and '/var/run/secrets/talos.dev/config' in order.
      --workers int                              the number of workers to create (default 1)
```
...
```
  ...
  -h, --help                                     help for config
      ...
      --install-image string                     the image used to perform an installation (default "ghcr.io/siderolabs/installer:v1.13.8")
      --kubernetes-version string                desired kubernetes version to run (default "1.36.2")
